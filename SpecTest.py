...
from Weapons.DDSwAvernic import DragonDagger1
...
dragon_dagger = DragonDagger1()  # DDS with Avernic defender
...
weapon_options = {
    ...
    '5': ('Dragon Dagger', dragon_dagger),
    '6': ('Scythe (regular hit)', scythe),
}
